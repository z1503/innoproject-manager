...
<!-- --------------------------------------- НОВЫЙ ПРОЕКТ МОДАЛЬНОЕ ОКНО ------------------------------------------------------ -->
<div id="project-modal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="lead text-primary" >Создать новый проект</h3>
            ...
            <form name="project" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" role="form">
                <div class="modal-body">				
                    <div class="form-group">
                        <label class="text-dark" for="project_name">Название проекта<span class="text-danger pl-1">*</span></label>
					...
					<div class="form-group">
						<label for="project_colour" class="text-dark">Цвет</label>

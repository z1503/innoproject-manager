        ...
        <div class="menu container">
            ...
            <div id="navbarSupportedContent" class="collapse navbar-collapse">
                <ul class="navbar-nav ml-auto">
                    <li><a href="login.php" class="btn text-white mr-2">Войти</a></li>
                </ul>
            </div>
        </div>
    </nav>
...
<div class="container">
    <div class="row m-0 p-0">
        ...
        <div class="col-6 p-5 justify-content-center">
            <p class="text-center h1 fw-bold m-5 text-black">Зарегистрироваться</p>
            <form class="px-5" name="signup" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
                ...
                <div class="mb-4">
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <span class="btn-sign-up input-group-text"> <small><i class="fas fa-key"></i></small></span>
                        </div>
                        <input class="form-control" type="password" name="password2" placeholder="Подтвердите пароль" required>
                    </div>
                </div>

                <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                    <button type="button" class="btn btn-primary" onclick="signup.submit()">Регистрация</button>
                </div>
            ...
            <span class="d-flex justify-content-center">Уже есть аккаунт? <a class="nav-link text-primary m-0 p-0 pl-2" href="login.php">Войти</a></span>
        </div>
    </div>
</div>
